 ...
 * 
 * SMS/이메일 통합 알림 설정 및 사용자별 선호도 관리를 위한
 * 사용자 설정 정보 조회 및 관리 기능 제공
 */
@Repository
public interface UserSettingsRepository extends JpaRepository<UserSettings, Long> {
    ...
    List<UserSettings> findByNotificationTimeBetween(@Param("startTime") LocalTime startTime,
    ...
    List<UserSettings> findForScheduledNotification(@Param("frequency") String frequency,
     ...
     * 알림 시간대별 사용자 분포 조회
     */
    @Query("SELECT us.notificationTime, COUNT(us) FROM UserSettings us " +
            "WHERE us.smsNotificationEnabled = true OR us.emailNotificationEnabled = true " +
     ...
     * 알림 주기별 사용자 분포 조회
     */
    @Query("SELECT us.notificationFrequency, COUNT(us) FROM UserSettings us " +
            "WHERE us.smsNotificationEnabled = true OR us.emailNotificationEnabled = true " +
