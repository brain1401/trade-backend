...
public class ExchangeRateController {
  ...
  public Mono<List<ExchangeRateResponse>> getExchangeRates() {
  ...
  public Mono<List<ExchangeRateResponse>> getExchangeRateByCurrency(@PathVariable String currencyCode) {
